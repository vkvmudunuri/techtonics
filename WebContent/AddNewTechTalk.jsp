...
<body>
	...
	<b><font face="Times New Roman"><h3>Give details for
				new TechTalk:</h3></font> </b>
	<form action="newTechTalk" method="post">
		<div class="form-group">
			<label>Date: </label> <input type="date" name="mydate" required
				class="form-control">
		</div>
		<div class="form-group">
			<label>Title: </label> <input type="text" name="mytitle" required
				class="form-control">
		</div>
		<div class="form-group">
			<label>Description: </label>
			<textarea required class="form-control" name="mydesc" rows="14"
				cols="40"></textarea>
		</div>
		...
		<div class="form-group">
			<label>Speaker: </label> <input type="text" name="myspeaker" required
				class="form-control">
		</div>
