...
<body>
	...
	<h2><%=request.getAttribute("msgAfterUploadTechTalk")%></h2>
	<div class="name">




		<!-- <img src="Resources/images/image8no.jpg" height="400" width="700"
			align="middle"> -->
	</div>
	<div id="container">
		...
		<form action="allTechTalks" method="get">
			<input type="submit" class="btn btn-primary"
				value="Go back to All Tech Talks">
		</form>
		<br>



		<form action="newTechTalk" method="get">
			<input type="submit" class="btn btn-success"
				value="Add 1 more Tech Talk">
		</form>
