...
<body>
	...
	<b><font face="Times New Roman"><h3>Give details to
				update any TechTalk schedule:</h3></font> </b>
	...
	<form action="updateTechTalk" method="post">
		...
		<div class="form-group">
			<label>Title: </label> <input type="text" name="mytitleForUpdate"
				required class="form-control">
		</div>

		<div class="form-group">
			<label>New Date: </label> <input type="date" name="mydateForUpdate"
				required class="form-control">
		</div>
	...
	<font face="Bedrock"><h2>Available Tech Talks......</h2></font>
